...
export default function CreateItem() {
  ...
  async function onChange(e) {
    ...
    try {
      ...
      const url = `https://optimism-demo1.infura-ipfs.io/ipfs/${added.path}`
      setFileUrl(url)
      //console.log(url);
    } catch (error) {
  ...
  async function listNFTForSale() {
    ...
    // Mint the NFT
    const boredPetsContractAddress = "0xE5E9F9ab877A31b36E77c3d7C3C5ec585d2de21E"
    ...
    //console.log(boredPetsContract.methods)
