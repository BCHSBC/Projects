...
export default function Home() {
  ...
  async function loadNFTs() {
    ...
    const nfts = await Promise.all(listings.map(async (i) => {
      try {
        const boredPetsContract = new web3.eth.Contract(BoredPetsNFT.abi, "0xE5E9F9ab877A31b36E77c3d7C3C5ec585d2de21E")
  ...
  async function buyNft(nft) {
    ...
    await marketPlaceContract.methods.buyNft("0xE5E9F9ab877A31b36E77c3d7C3C5ec585d2de21E", nft.tokenId).send({ from: accounts[0], value: nft.price });
    loadNFTs()
  }
